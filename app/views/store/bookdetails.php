                        ...
                        <div class="product-details-info pl-lg--30 ">
                            ...
                            <div class="add-to-cart-row">
                                ...
                                <div class="add-cart-btn">
                                    <!-- <?php print_r($data['book']['id']);?> -->
                                    <a href="<?=ROOT?>cart/<?=$data['book']['id']?>" class="btn btn-outlined--primary"><span class="plus-icon">+</span>Add to
                                        Cart</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-content space-db--20" id="myTabContent">
                        <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab1">
                            <article class="review-article">
                                <h1 class="sr-only">Book Article</h1>
                                <p>"JavaScript: The Definitive Guide" is a comprehensive and in-depth reference book for JavaScript,
                                    covering the language's syntax, features, and best practices. Written by David Flanagan, this book
                                    explores everything from basic language concepts and programming techniques to advanced topics like
                                    browser APIs and server-side JavaScript. It provides clear explanations, practical examples, and
                                    detailed reference material that makes it an essential resource for both beginner and experienced
                                    JavaScript developers. With its detailed coverage and practical approach, "JavaScript: 
                                    The Definitive Guide" is an excellent book for anyone looking to master the language.</p>
                            </article>
                        </div>
                                    ...
                                    <div class="card-image">
                                        ...
                                        <div class="hover-contents">
                                            ...
                                            <div class="hover-btns">
                                                <a href="<?=ROOT?>cart/<?=$data['book']['id']?>" class="single-btn">
                        ...
                        <div class="col-lg-7 mt--30 mt-lg--30">
                            <div class="product-details-info pl-lg--30 ">
                                ...
                                <div class="add-to-cart-row">
                                    ...
                                    <div class="add-cart-btn">
                                        <a href="<?=ROOT?>cart/<?=$data['book']['id']?>" class="btn btn-outlined--primary"><span
